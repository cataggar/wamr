...
/// Requires `jit`. Documented in `docs/design/lazy-jit-spike.md`, including
/// #887's non-leaf x86_64 support, #888's native trampolines, #890's aarch64
/// backend parity, #892's deferred per-function IR-pass pipeline, and #889's
/// in-memory component precompile threading.
...
pub const benchmark_interp_fuel =
    optInt(u32, "benchmark_interp_fuel", 100_000_000);
