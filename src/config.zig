...
/// Requires `jit`. Today this is the narrow x86_64 leaf-function lazy-JIT
/// path documented in `docs/design/lazy-jit-spike.md`, including #892's
/// deferred per-function IR-pass pipeline.
