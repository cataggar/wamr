...
pub fn build(b: *std.Build) void {
    ...
    const thread_lifecycle_unit_tests = b.addTest(.{
        ...
        .filters = &.{
            ...
            "termination:",
            "task cancellation:",
            "task cancellation ticket:",
            "TaskManager: handle cancellation",
            "TaskManager: registered cancellation",
            "TaskManager: cancellation sources",
            "TaskManager: durable cancellation",
            "TaskManager: ticket acquired",
            "TaskManager: invalid and stale",
            "TaskManager: task source allocation",
            "dispatchCanonBuiltin: subtask.cancel",
            "dispatchCanonBuiltin: task.cancel",
            "AOT thread",
    ...
    const windows_poll_unit_tests = b.addTest(.{
        ...
        .filters = &.{
            ...
            "ThreadManager: Windows task cancel",
