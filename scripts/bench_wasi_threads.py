...
SIZING_CELL_BASE_OVERRIDES = (
    ...
    {
        "name": "hot-8-20s-process-cpu-window",
        "selector": {
            "workload": "hot",
            "threads": 8,
        },
    ...
    *(
        {
            "name": "atomic-2-4-40s-contention-window",
            "selector": {
                "workload": "atomic",
                "threads": threads,
            },
            ...
            "projected_pilot_duration_ns": 40_000_000_000,
            "formula": SIZING_FORMULA,
        }
        for threads in (2, 4)
    ),
    {
        "name": "atomic-8-20s-contention-window",
        "selector": {
            "workload": "atomic",
            "threads": 8,
        },
...
WORKFLOW_JOB_TIMEOUT_NS = 330 * 60 * 1_000_000_000
